...
from drip.utils import get_user_model, parse_time
...
class SentDrip(models.Model):
    ...
    drip = models.ForeignKey(
        "drip.Drip", related_name="sent_drips", on_delete=models.DO_NOTHING
    )
...
class QuerySetRule(models.Model):
    ...
    drip = models.ForeignKey(Drip, related_name="queryset_rules", on_delete=models.DO_NOTHING)
