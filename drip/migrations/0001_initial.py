# Generated by Django 3.0.7 on 2021-03-13 01:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drip', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='sent_drips', to='drip.Drip')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='sent_drips', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='QuerySetRule',
            fields=[
                ...
                ('drip', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='queryset_rules', to='drip.Drip')),
            ],
        ),
    ]
